# -*- coding: utf-8 -*-
"""
Created on Wed Oct 18 12:05:38 2023
...
tree = ET.parse("Map_3.xml")
root = tree.getroot()

# Iterate over the 'item' elements and extract names and values
...
result_tree.write("reduce_3.xml", encoding="utf-8")